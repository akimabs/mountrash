...
export default function Home({navigation}: any) {
  const [action] = React.useState([
    ...
    [news] = React.useState([
      {
        title: 'Gerakan pantai bersih',
        subtitle: 'pantai akan di bersihkan dalam rangka 17 agustusan',
        image:
          'https://akcdn.detik.net.id/visual/2018/04/15/981e7a76-4aa8-4d2a-b59d-fbda4dafa243_169.jpeg?w=650',
      },
      {
        title: 'Gerakan pantai bersih',
        subtitle: 'pantai akan di bersihkan dalam rangka 17 agustusan',
